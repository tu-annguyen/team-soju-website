...
const FEEBAS_LOCATIONS = {
  ...
  'route-119-upstream': {
    ...
    rows: ROUTE_119_UPSTREAM_MASK.length,
    cols: ROUTE_119_UPSTREAM_MASK[0].length,
    tiles: buildTilesFromMask(ROUTE_119_UPSTREAM_MASK),
  },
  'mt-coronet': {
    id: 'mt-coronet',
    displayName: 'Mt. Coronet, Sinnoh',
    description: 'Mt. Coronet pond tiles for live Feebas coordination.',
    rows: MT_CORONET_MASK.length,
    cols: MT_CORONET_MASK[0].length,
    tiles: buildTilesFromMask(MT_CORONET_MASK),
  },
};
