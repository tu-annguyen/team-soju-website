    ...
    <section className="py-16 bg-gray-50 dark:bg-gray-800">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <LinkCard
            title="Join Our Team"
            description="Interested in joining Team Soju? Apply through the forums or Discord server and become part of our growing community!"
          ...
          <LinkCard
            ...
            description="Stay updated with the latest team events and news on the PokeMMO forums."
