...
const en = {
  ...
  fields: {
    ...
    time: 'Time', minimumTier: 'Minimum Tier', minimumLevel: 'Minimum level', minimumPoints: 'Minimum points/hour',
  ...
  boosts: 'Boosts and charms', charms: 'Charms', noExpCharm: 'No EXP Charm', expCharm25: 'EXP Charm +25%', expCharm50: 'EXP Charm +50%', expCharm100: 'EXP Charm +100%',
  ...
  results: {
    ...
    split: 'split', splits: 'splits', encounter: 'encounter', lowerPoints: 'lower points/hour', additionalExp: 'additional EXP/hour',
    ...
    includesLure: 'Includes Lure-only encounters', includesSpecial: 'Includes Special encounters', lureOnly: 'Lure only', special: 'Special',
  },
...
const es: HuntFinderMessages = {
  ...
  fields: { season: 'Estación', region: 'Región', location: 'Lugar', species: 'Especie', method: 'Método de encuentro', time: 'Hora', minimumTier: 'Tier mínimo', minimumLevel: 'Nivel mínimo', minimumPoints: 'Puntos/hora mínimos', hordeSize: 'Tamaño de horda', hordesPerHour: 'Hordas/hora', sortBy: 'Ordenar por', direction: 'Dirección' },
  ...
  evYield: 'EV otorgados', evStats: { hp: 'PS', attack: 'Ataque', defense: 'Defensa', spAttack: 'Ataque Especial', spDefense: 'Defensa Especial', speed: 'Velocidad' },
  boosts: 'Mejoras y amuletos', charms: 'Amuletos', noExpCharm: 'Sin amuleto de EXP', expCharm25: 'Amuleto de EXP +25%', expCharm50: 'Amuleto de EXP +50%', expCharm100: 'Amuleto de EXP +100%', eventBoost: 'Evento +10%', donator: 'Donador +10%', personalCharm: 'Amuleto personal', linkCharm: 'Amuleto de enlace', chumBucket: 'Cubo de cebo',
...
const zh: HuntFinderMessages = {
  ...
  fields: { season: '季节', region: '地区', location: '地点', species: '宝可梦', method: '遭遇方式', time: '时段', minimumTier: '最低阶级', minimumLevel: '最低等级', minimumPoints: '最低积分/小时', hordeSize: '群怪数量', hordesPerHour: '每小时群怪数', sortBy: '排序方式', direction: '排序方向' },
  ...
  evYield: 'EV 产出', evStats: { hp: 'HP', attack: '攻击', defense: '防御', spAttack: '特攻', spDefense: '特防', speed: '速度' },
  boosts: '加成与护符', charms: '护符', noExpCharm: '无经验护符', expCharm25: '经验护符 +25%', expCharm50: '经验护符 +50%', expCharm100: '经验护符 +100%', eventBoost: '活动 +10%', donator: '捐赠者 +10%', personalCharm: '个人护符', linkCharm: '组队护符', chumBucket: '诱饵桶',
