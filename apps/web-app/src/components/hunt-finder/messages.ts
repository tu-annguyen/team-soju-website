...
const en = {
  ...
  sections: { filters: 'Filters', sort: 'Sort', advancedFilters: 'Advanced Filters', infoDisplayOptions: 'Info Display Options' },
  fields: {
    season: 'Season', region: 'Region', location: 'Location', species: 'Species', method: 'Encounter method',
    time: 'Time', minimumTier: 'Minimum tier', minimumLevel: 'Minimum level', maximumLevel: 'Maximum level', minimumPoints: 'Minimum points/hour', minimumExp: 'Minimum EXP/hour',
    hordeSize: 'Horde size', hordesPerHour: 'Hordes/hour', encountersPerHour: 'Encounters/hour', sortBy: 'Sort by', direction: 'Sort direction',
  },
  options: {
    ...
    day: 'Day', night: 'Night', noMinimum: 'No minimum', noMaximum: 'No maximum', hourlyUnavailable: 'Hourly data unavailable', bothHordes: '3× and 5×',
    threeOnly: '3× only', fiveOnly: '5× only', pointsHour: 'Points/hour', expHour: 'EXP/hour', alphabetical: 'Alphabetical',
    descending: 'Descending', ascending: 'Ascending', excludeZeroExp: 'Exclude 0 EXP/hour', fullSplit: '100% split hordes only', nonSafari: 'Non-Safari only',
  },
  evYield: 'EV yield',
  exclusiveEvYield: 'Only selected EV yields',
  eggGroups: 'Egg groups',
  displayedPokemonInfo: 'Displayed Pokémon Info',
  displayedPokemonInfoActions: { showAll: 'Show all', hideAll: 'Hide all' },
  pokemonInfo: { pointsPerHour: 'Points/hour', expPerHour: 'EXP/hour', averageExp: 'Average EXP/encounter', averageShiny: 'Average/shiny', encountersPerHour: 'Encounters/hour', effectiveOdds: 'Effective odds', tier: 'Tier', level: 'Level', evYield: 'EV yield', eggGroups: 'Egg groups' },
  ...
  results: {
    location: 'Location', pokemon: 'Pokémon', collapseAllLocations: 'Collapse all locations', openAllLocations: 'Open all locations', collapseAllSplits: 'Collapse all splits', openAllSplits: 'Open all splits', matching: 'matching encounter groups. Rates are normalized within each location/time group.',
    showing: 'Showing {shown} of {total} matching encounter groups. Rates are normalized within each location/time group.',
    loading: 'Loading hunt results', refreshing: 'Refreshing hunt results', loadMore: 'Load more', loadingMore: 'Loading more',
    couldNotLoad: 'Could not load hunts.', couldNotLoadMore: 'Could not load more hunts.', wildLocation: 'wild location', wildLocations: 'wild locations', point: 'point', points: 'points',
    split: 'split', splits: 'splits', encounter: 'encounter', lowerPoints: 'lower points/hour', higherPoints: 'higher points/hour', lowerExp: 'lower EXP/hour', higherExp: 'higher EXP/hour',
...
const es: HuntFinderMessages = {
  ...
  sections: { filters: 'Filtros', sort: 'Ordenar', advancedFilters: 'Filtros avanzados', infoDisplayOptions: 'Opciones de información' },
  fields: { season: 'Estación', region: 'Región', location: 'Lugar', species: 'Especie', method: 'Método de encuentro', time: 'Hora', minimumTier: 'Tier mínimo', minimumLevel: 'Nivel mínimo', maximumLevel: 'Nivel máximo', minimumPoints: 'Puntos/hora mínimos', minimumExp: 'EXP/hora mínima', hordeSize: 'Tamaño de horda', hordesPerHour: 'Hordas/hora', encountersPerHour: 'Encuentros/hora', sortBy: 'Ordenar por', direction: 'Dirección' },
  options: { anySeason: 'Cualquier estación', everyRegion: 'Todas las regiones', everyLocation: 'Todos los lugares', everySpecies: 'Todas las especies', everyMethod: 'Todos los métodos de encuentro salvaje', sweetScent: 'Dulce Aroma (Hordas)', singles: 'Individuales', fishing: 'Pesca', honeyTrees: 'Árboles de miel', headbutt: 'Golpe Cabeza', rockSmash: 'Golpe Roca', anyTime: 'Cualquier hora', morning: 'Mañana', day: 'Día', night: 'Noche', noMinimum: 'Sin mínimo', noMaximum: 'Sin máximo', hourlyUnavailable: 'Datos por hora no disponibles', bothHordes: '3× y 5×', threeOnly: 'Solo 3×', fiveOnly: 'Solo 5×', pointsHour: 'Puntos/hora', expHour: 'EXP/hora', alphabetical: 'Alfabético', descending: 'Descendente', ascending: 'Ascendente', excludeZeroExp: 'Excluir 0 EXP/hora', fullSplit: 'Solo hordas con reparto al 100%', nonSafari: 'Solo fuera de Safari' },
  evYield: 'EV otorgados', exclusiveEvYield: 'Solo los EV seleccionados', eggGroups: 'Grupos Huevo', displayedPokemonInfo: 'Información de Pokémon mostrada', displayedPokemonInfoActions: { showAll: 'Mostrar todo', hideAll: 'Ocultar todo' }, pokemonInfo: { pointsPerHour: 'Puntos/hora', expPerHour: 'EXP/hora', averageExp: 'EXP media/encuentro', averageShiny: 'Media/shiny', encountersPerHour: 'Encuentros/hora', effectiveOdds: 'Probabilidad efectiva', tier: 'Tier', level: 'Nivel', evYield: 'EV otorgados', eggGroups: 'Grupos Huevo' }, evStats: { hp: 'PS', attack: 'Ataque', defense: 'Defensa', spAttack: 'Ataque Especial', spDefense: 'Defensa Especial', speed: 'Velocidad' },
  ...
  results: { location: 'Lugar', pokemon: 'Pokémon', collapseAllLocations: 'Contraer todos los lugares', openAllLocations: 'Abrir todos los lugares', collapseAllSplits: 'Contraer todos los repartos', openAllSplits: 'Abrir todos los repartos', matching: 'grupos de encuentros coincidentes. Las tasas se normalizan dentro de cada grupo de lugar/hora.', showing: 'Mostrando {shown} de {total} grupos de encuentros coincidentes. Las tasas se normalizan dentro de cada grupo de lugar/hora.', loading: 'Cargando resultados de cacería', refreshing: 'Actualizando resultados de cacería', loadMore: 'Cargar más', loadingMore: 'Cargando más', couldNotLoad: 'No se pudieron cargar las cacerías.', couldNotLoadMore: 'No se pudieron cargar más cacerías.', wildLocation: 'lugar salvaje', wildLocations: 'lugares salvajes', point: 'punto', points: 'puntos', split: 'reparto', splits: 'repartos', encounter: 'encuentro', lowerPoints: 'con menos puntos/hora', higherPoints: 'con más puntos/hora', lowerExp: 'con menos EXP/hora', higherExp: 'con más EXP/hora', show: 'Mostrar', hide: 'Ocultar', collapse: 'Contraer', expand: 'Expandir', queue: 'Añadir a cola', huntNow: 'Cazar ahora', averageExp: 'EXP media/encuentro', averageShiny: 'media/shiny', noHourly: 'Sin datos fiables de encuentros/hora', encountersHour: 'encuentros/hora', effectiveOdds: 'probabilidad efectiva', includesLure: 'Incluye encuentros con Señuelo', includesSpecial: 'Incluye encuentros especiales', lureOnly: 'Señuelo', special: 'Especial' },
...
const zh: HuntFinderMessages = {
  ...
  sections: { filters: '筛选', sort: '排序', advancedFilters: '高级筛选', infoDisplayOptions: '信息显示选项' },
  fields: { season: '季节', region: '地区', location: '地点', species: '宝可梦', method: '遭遇方式', time: '时段', minimumTier: '最低阶级', minimumLevel: '最低等级', maximumLevel: '最高等级', minimumPoints: '最低积分/小时', minimumExp: '最低经验/小时', hordeSize: '群怪数量', hordesPerHour: '每小时群怪数', encountersPerHour: '每小时遭遇数', sortBy: '排序方式', direction: '排序方向' },
  options: { anySeason: '任意季节', everyRegion: '所有地区', everyLocation: '所有地点', everySpecies: '所有宝可梦', everyMethod: '所有野外遭遇方式', sweetScent: '甜甜香气（群怪）', singles: '单只遭遇', fishing: '钓鱼', honeyTrees: '蜂蜜树', headbutt: '头锤', rockSmash: '碎岩', anyTime: '任意时段', morning: '早晨', day: '白天', night: '夜晚', noMinimum: '无最低限制', noMaximum: '无最高限制', hourlyUnavailable: '无每小时数据', bothHordes: '3× 和 5×', threeOnly: '仅 3×', fiveOnly: '仅 5×', pointsHour: '积分/小时', expHour: '经验/小时', alphabetical: '字母顺序', descending: '降序', ascending: '升序', excludeZeroExp: '排除 0 经验/小时', fullSplit: '仅 100% 固定群怪', nonSafari: '仅非狩猎地带' },
  evYield: 'EV 产出', exclusiveEvYield: '仅限所选 EV 产出', eggGroups: '蛋群', displayedPokemonInfo: '显示的宝可梦信息', displayedPokemonInfoActions: { showAll: '全部显示', hideAll: '全部隐藏' }, pokemonInfo: { pointsPerHour: '积分/小时', expPerHour: '经验/小时', averageExp: '平均经验/遭遇', averageShiny: '平均值/闪光', encountersPerHour: '每小时遭遇数', effectiveOdds: '有效概率', tier: '阶级', level: '等级', evYield: 'EV 产出', eggGroups: '蛋群' }, evStats: { hp: 'HP', attack: '攻击', defense: '防御', spAttack: '特攻', spDefense: '特防', speed: '速度' },
  ...
  results: { location: '地点', pokemon: '宝可梦', collapseAllLocations: '折叠所有地点', openAllLocations: '展开所有地点', collapseAllSplits: '折叠所有组合', openAllSplits: '展开所有组合', matching: '个符合条件的遭遇组。概率按各地点/时段组归一化。', showing: '正在显示 {total} 个符合条件的遭遇组中的 {shown} 个。概率按各地点/时段组归一化。', loading: '正在加载狩猎结果', refreshing: '正在更新狩猎结果', loadMore: '加载更多', loadingMore: '正在加载更多', couldNotLoad: '无法加载狩猎数据。', couldNotLoadMore: '无法加载更多狩猎数据。', wildLocation: '个野外地点', wildLocations: '个野外地点', point: '积分', points: '积分', split: '组合', splits: '组合', encounter: '遭遇', lowerPoints: '较低积分/小时', higherPoints: '较高积分/小时', lowerExp: '较低经验/小时', higherExp: '较高经验/小时', show: '显示', hide: '隐藏', collapse: '折叠', expand: '展开', queue: '加入队列', huntNow: '立即狩猎', averageExp: '平均经验/遭遇', averageShiny: '平均值/闪光', noHourly: '没有可靠的每小时遭遇数据', encountersHour: '次遭遇/小时', effectiveOdds: '有效概率', includesLure: '包含诱饵遭遇', includesSpecial: '包含特殊遭遇', lureOnly: '诱饵', special: '特殊' },
