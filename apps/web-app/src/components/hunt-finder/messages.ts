...
const en = {
  ...
  pokemonInfo: { pointsPerHour: 'Points/hour', averageShiny: 'Average/shiny', encountersPerHour: 'Encounters/hour', effectiveOdds: 'Effective odds', tier: 'Tier', level: 'Level', evYield: 'EV yield', eggGroups: 'Egg groups' },
...
const zh: HuntFinderMessages = {
  ...
  evYield: 'EV 产出', exclusiveEvYield: '仅限所选 EV 产出', eggGroups: '蛋群', displayedPokemonInfo: '显示的宝可梦信息', pokemonInfo: { pointsPerHour: '积分/小时', averageShiny: '平均值/闪光', encountersPerHour: '每小时遭遇数', effectiveOdds: '有效概率', tier: '阶级', level: '等级', evYield: 'EV 产出', eggGroups: '蛋群' }, evStats: { hp: 'HP', attack: '攻击', defense: '防御', spAttack: '特攻', spDefense: '特防', speed: '速度' },
