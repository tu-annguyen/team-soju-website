...
const en = {
  ...
  results: {
    ...
    loading: 'Loading hunt results', couldNotLoad: 'Could not load hunts.', wildLocation: 'wild location', wildLocations: 'wild locations', point: 'point', points: 'points',
