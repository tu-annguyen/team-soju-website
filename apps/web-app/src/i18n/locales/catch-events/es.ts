const catchEventManager = {
  ...
  "End time must be after start time.": "La hora de fin debe ser posterior a la hora de inicio.",
    ...
    "Create PokeMMO catch events, collect manual entries, calculate scores, and publish final leaderboards when staff is ready.": "Crea eventos de captura de PokeMMO, recibe participaciones manuales, calcula puntuaciones y publica clasificaciones finales cuando el staff esté listo.",
    "Events": "Eventos",
    "Create": "Crear",
    "Manage": "Gestionar",
  ...
  "fields": "campos",
    ...
    "Duplicate setup": "Duplicar configuración",
    "Edit event": "Editar evento",
