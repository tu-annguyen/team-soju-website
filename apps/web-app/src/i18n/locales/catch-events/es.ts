const catchEventManager = {
  ...
  "End time must be after start time.": "La hora de fin debe ser posterior a la hora de inicio.",
    ...
    "No valid entries yet.": "Aún no hay participaciones válidas.",
    "Rank": "Puesto",
    "Player": "Jugador",
    "Pokemon": "Pokémon",
    "Score": "Puntuación",
    ...
    "Reserve the final winner slot for the lowest valid score.": "Reservar el último puesto ganador para la puntuación válida más baja.",
