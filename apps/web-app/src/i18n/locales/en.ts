...
const en = {
  ...
  tools: {
    ...
    feebasChecker: {
      ...
      weather: {
        heading: 'Route 119 Weather',
        currentLabel: 'Current weather',
        unknown: 'Unknown',
        confirmedBy: 'Confirmed by {actorName}',
        minimumCyclesLabel: 'Minimum cycles until possible weather change',
        values: {
          rainy: 'Rainy',
          clear: 'Clear',
        },
        reportAction: 'Report {weather}',
        confirmAction: 'Confirm {weather}',
      ...
      errors: {
        ...
        updateWeather: 'Unable to update Route 119 weather',
