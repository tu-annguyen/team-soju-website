...
const es = {
  ...
  auth: {
    ...
    heading: 'Cuenta de Team Soju',
    signedInHeading: 'Sesion iniciada',
    signedInCopy: 'Bienvenido de nuevo, {ign}.',
    email: 'Correo electronico',
    password: 'Contrasena',
    passwordRequirements: 'Usa 8 caracteres o mas, con al menos un numero y un caracter especial.',
    confirmPassword: 'Vuelve a escribir la nueva contrasena',
    ign: 'Nombre dentro del juego',
    ...
    forgotPasswordCopy: 'Ingresa el correo de tu cuenta de Team Soju y te enviaremos un enlace para restablecerla.',
    sendResetLink: 'Enviar enlace',
    resetEmailSent: 'Si existe una cuenta con ese correo, se envio un enlace de restablecimiento.',
    resetPasswordHeading: 'Elige una nueva contrasena',
    resetPasswordCopy: 'Ingresa una nueva contrasena para tu cuenta de Team Soju.',
    newPassword: 'Nueva contrasena',
    resetPasswordSubmit: 'Restablecer contrasena',
    successPasswordReset: 'Contrasena restablecida correctamente.',
    backToSignIn: 'Volver a iniciar sesion',
    discordLogin: 'Continuar con Discord',
    discordRegister: 'Crear con Discord',
    signOut: 'Cerrar sesion',
    loading: 'Comprobando tu sesion...',
    successLogin: 'Sesion iniciada correctamente.',
    successRegister: 'Cuenta creada. Revisa tu correo para verificarla antes de iniciar sesion.',
    successEmailVerified: 'Correo verificado. Ya puedes iniciar sesion.',
    accountDetailsHeading: 'Detalles de la cuenta',
    accountSettingsHeading: 'Configuracion de la cuenta',
    accountSettingsCopy: 'Administra tu correo, tu contrasena y los metodos de acceso vinculados.',
    changeEmailHeading: 'Cambiar correo',
    changeEmailCopy: 'Al actualizar tu correo se enviara un nuevo enlace de verificacion a esa direccion.',
    newEmail: 'Nuevo correo',
    changeEmailSubmit: 'Actualizar correo',
    changePasswordHeading: 'Cambiar contrasena',
    setPasswordHeading: 'Agregar una contrasena',
    changePasswordCopy: 'Usa 8 caracteres o mas, con al menos un numero y un caracter especial.',
    currentPassword: 'Contrasena actual',
    currentPasswordOptional: 'Contrasena actual (todavia no es obligatoria)',
    changePasswordSubmit: 'Actualizar contrasena',
    setPasswordSubmit: 'Guardar contrasena',
    connectDiscordHeading: 'Conexion de Discord',
    connectDiscordCopy: 'Vincula Discord para iniciar sesion mas rapido y mantener tu cuenta conectada.',
    connectDiscordSubmit: 'Conectar Discord',
    discordLinked: 'Discord conectado',
    discordNotLinked: 'Discord no conectado',
    errors: {
  ...
  tools: {
    index: {
      ...
      shinyWarCard: {
        title: 'Panel de Shiny Wars',
        description: 'Sigue la clasificación de Team Soju y el progreso de Shiny Wars.',
      },
    },
    feebas: {
    ...
    feebasChecker: {
      ...
      locations: {
        route119: {
          ...
          pondTabLabel: 'Estanque',
          upstreamTabLabel: 'Aguas arriba',
        },
        mtCoronet: {
      ...
      heatmap: {
        ...
        shortcutLabel: 'Atajo: {key}',
        changeShortcut: 'Cambiar',
        resetShortcut: 'Restablecer',
        shortcutCaptureHint: 'Pulsa una tecla',
        invalidShortcut: 'Usa una sola tecla que no sea espacio, sin modificadores.',
