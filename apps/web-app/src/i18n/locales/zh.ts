  ...
  tools: {
    ...
    feebasChecker: {
      ...
      general: {
        ...
        patternVotesHint: '图案覆盖会把不同意见拆成不同纹理区域。投票越多，对应区域越明显。',
      ...
      weather: {
        ...
        currentLabel: '当前天气',
        unknown: '未知',
        confirmedBy: '由 {actorName} 确认',
        minimumCyclesLabel: '距离可能变更天气的最少周期',
        values: {
          rainy: '下雨',
          clear: '晴朗',
        },
        reportAction: '报告{weather}',
        confirmAction: '确认{weather}',
        alreadyReported: '已报告',
