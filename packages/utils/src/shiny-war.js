export const SHINY_WAR_2026 = Object.freeze({
  id: '2026',
...
export function getShinyWarSeason(at = new Date(), event = SHINY_WAR_2026) {
...
export function effectiveShinyDenominator({
  eventBoost = true,
  donator = false,
  personalCharm = false,
  linkCharm = false,
...
export function calculateHordeMetrics(species, {
  hordesPerHour = 240,
  denominator = 30000,
  hordeSize = 5,
} = {}) {
...
export function getCatchBasePoints(catchEntry) {
...
export function isEligibleCatch(catchEntry, event = SHINY_WAR_2026) {
...
export function scoreShinyWarCatches(catches, participantIds, event = SHINY_WAR_2026) {
